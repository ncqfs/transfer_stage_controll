...
private:
	...
	// 复制和赋值禁用
	BluetoothMotorController(const BluetoothMotorController&) = delete;
	BluetoothMotorController& operator=(const BluetoothMotorController&) = delete;
};
